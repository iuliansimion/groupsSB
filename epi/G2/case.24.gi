...
#
# Read("~/Workspace/groupsSB/epi/G2/case.24.gi");
#
...
getRep:=function(k,t)
    ...
    #uaab:=ext_root_group(k,4,t); 
    uaaab:=ext_root_group(k,5,t); 
    uaaabb:=ext_root_group(k,6,t^2/2);
    u:=ub*uab;#*uaaab*uaaabb;
